...
def search_ismcts(initial_game_state, possible_hidden_states, num_iterations):
    ...
    return max(root.children, key=lambda action: root.children[action].visit_count), root
...
if __name__ == "__main__":
    ...
    action, root = search_ismcts(start, possible_hidden_states, 1000)
    print action
    print root
